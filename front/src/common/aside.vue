<template>
  <div>
    <el-menu
      ...
      <el-menu-item index="course" v-if="type === 0" :class="{active: $route.name === '课程录入'}">
        <i class="el-icon-s-promotion"></i>
        <span slot="title">&#12288课程录入</span>
      </el-menu-item>

      <el-submenu index="setting" v-if="type === 0">
        <template slot="title">
      ...
      <el-menu-item index="account" v-if="type === 0" :class="{active: $route.name === '账号管理'}">
