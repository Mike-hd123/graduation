...
export default {
  ...
  methods: {
    async getProfessionInfo() {
      const { data: res } = await this.axios.get("/teacher/getProfessionInfoByTeacher");
      if (res.code === 200) {
    ...
    getChartData(data) {
      this.axios
        .get("/teacher/export", { params: data })
        .then((response) => {
    ...
    getPieData(data) {
      this.axios
        .get("/teacher/getUserNum", { params: data })
        .then((response) => {
          let data = response.data.data;
    ...
    getTotal() {
      ...
      this.axios.get("/teacher/getUserTotal", { params: obj }).then((response) => {
