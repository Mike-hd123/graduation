...
export default {
  ...
  methods: {
    getProfessionInfo() {
      this.axios
        .get("/admin/teach/getProfessionInfoByAdmin")
        .then((response) => {
    ...
    getChartData(data) {
      this.axios
        .get("/admin/score/export", { params: data })
        .then((response) => {
          const { data: res } = response;
          let data = res.data;
    ...
    getPieData(data) {
      this.axios
        .get("/admin/score/getUserNum", { params: data })
        .then((response) => {
          const { data: res } = response;
          let data = res.data;
    ...
    getTotal() {
      ...
      this.axios.get("/admin/score/getUserTotal", { params: obj }).then((response) => {
        const { data: res } = response;
        let obj = res.data;
        let current = {
