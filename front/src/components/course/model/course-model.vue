  ...
  data() {
    return {
      ...
      rules: {
        ...
        point: [{ required: true, message: "绩点不能为空", trigger: "blur" }],
        score: [{ required: true, message: "满分项不能为空", trigger: "blur" }],
        number: [{ required: true, message: "课时不能为空", trigger: "blur" }],
        profession: [{ required: true, message: "专业名不能为空", trigger: "change" }],
        start: [{ required: true, message: "开始周", trigger: "blur" }],
        end: [{ required: true, message: "结束周", trigger: "blur" }],
        room: [{ required: true, message: "教室", trigger: "blur" }],
      },
    };
  },
  methods: {
    ...
    getProfession() {
      this.axios.get("/profession/getProfessionList").then((response) => {
